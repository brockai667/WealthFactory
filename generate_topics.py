...
def build_prompt(n, existing_titles):
    return (
        ...
        "- each segment 'keywords': 1-3 ENGLISH words for real stock footage on Pexels, money/luxury/"
        "business themed (e.g. 'money cash', 'city skyline', 'luxury car', 'stock market chart', "
        "'business man suit', 'luxury house real estate'). Avoid abstract words with no footage.\n"
